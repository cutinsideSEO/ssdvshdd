...
export default function HDDvsSSDPage() {
  ...
  const imgs = {
    blue: 'https://www.westerndigital.com/content/dam/store/en-us/assets/products/internal-storage/wd-blue-desktop-sata-hdd/gallery/wd-blue-pc-desktop-hard-drive-1tb.png.thumb.1280.1280.png',
